module.exports.day1 = ``
module.exports.day2 = `121	59	141	21	120	67	58	49	22	46	56	112	53	111	104	130
...
module.exports.day3 = 347991
module.exports.day4 = `vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
...
kyshwy (60)
baomcxj (54)`
module.exports.day8 = `kd dec -37 if gm <= 9
x dec -715 if kjn == 0
ey inc 249 if x < 722
n dec 970 if t > 3
f dec -385 if msg > -3
...
module.exports.day19 = `                                                               |                                                                                                                                         
 ...
 +-------+     +---------------+   +-----------------------------------------------------------------------+                                               +-+     +---------------------+               
                                                                                                                                                                                                         `
module.exports.day20 = `p=<1609,-863,-779>, v=<-15,54,-69>, a=<-10,0,14>
